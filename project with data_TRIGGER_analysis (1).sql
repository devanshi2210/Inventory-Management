...
#1.Month with highest business (i..e highest revenue)
#2.Most buying customer
#3 Highest sold products
#4 Which products sold in which month and number of units
#5 which months had highest customer engagement
...
#4which products sold in which month and number of units
...
#5 which months had highest customer engagement
select count(customer_id) as customer_count ,DATE_FORMAT(order_date, '%M') AS month 
